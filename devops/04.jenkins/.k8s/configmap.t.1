...
data:
  jenkins.yaml: |
      ...
      system:
        ...
        - credentials:
          - usernamePassword:
              ...
              id: "skala-github-id"
              username: "himang10"
              password: "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"
          - string:
              scope: GLOBAL
    ...
    unclassified:
      location:
        url: "https://${USER_NAME}-ingress.skala25a.project.skala-ai.com/jenkins/"
